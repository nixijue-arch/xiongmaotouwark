...
export interface TTSClip extends BaseClip { trackId: 'tts'; text: string; voice: string; audioSrc?: string; audioDuration?: number; genFailed?: boolean; audioEngine?: 'youdao' | 'baidu' | 'proxy'; linkedCaptionId?: string; playbackRate?: number; userAudio?: boolean; /* 用户上传的 mp3 配音 — audioSrc 直接用, 不走 TTS auto-gen */ }
