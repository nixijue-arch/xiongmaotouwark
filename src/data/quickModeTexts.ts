...
//
// ============== 协作者快速上手 ==============
// 在 TEXTS_ZH (中文) / TEXTS_EN (英文) 数组里加一行就完事:
...
// 完整贡献流程: 见 ./CONTRIBUTING.md (DEV 文案管理页可视化加 → 导出 TS code → 粘到这里)
//
// ============== 历史 ==============
...
export const TEXTS_ZH: ModedText[] = [
  ...
  { text: '单币1M', tags: ['fomo'] },
  { text: '不要对短期的波动过于敏感', tags: ['fomo'] },
  { text: '不要对长期的涨幅缺乏想象', tags: ['fomo'] },
...
export const TEXTS_EN: ModedText[] = [
  // ---- FUD (annoyingjeetpack style + cooked + cope) ----
  // slash commands / admin 骚扰
  { text: '/site', tags: ['fud'] },
  { text: 'site??', tags: ['fud'] },
  { text: 'SITE???', tags: ['fud'] },
  ...
  // ---- FOMO (真 CT bullish, 不要 corporate) ----
  { text: 'lfg', tags: ['fomo'] },
  ...
  { text: 'next eth', tags: ['fomo'] },
  { text: 'next sol', tags: ['fomo'] },
  { text: 'next doge', tags: ['fomo'] },
  { text: 'next trump', tags: ['fomo'] },
  { text: 'next pepe', tags: ['fomo'] },
  { text: 'next 100x', tags: ['fomo'] },
  { text: 'next bitcoin', tags: ['fomo'] },
  ...
  // ---- Roast (CT jeet 互喷 + 抽象 + TikTok/4chan) ----
  // CT jeet 互喷
  ...
  // 抽象 / TikTok / 4chan / Z gen (合入 roast)
