...
export const CHIP_DEFS: ChipDef[] = [
  ...
  { group: 'mood', emoji: '🐶', label: '狗头', terms: ['狗头', '保命', '皮', '反讽'], featured: true },
  ...
  // ===== action / scene (20) =====
  { group: 'action', emoji: '💼', label: '打工', terms: ['打工', '上班', '加班', '工作', '搬砖'], featured: true },
  ...
  { group: 'action', emoji: '🛌', label: '躺平', terms: ['躺平', '摆烂', '佛系', '咸鱼', '不想干'], featured: true },
  ...
  { group: 'action', emoji: '🍉', label: '吃瓜', terms: ['吃瓜', '看戏', '围观', '瓜'], featured: true },
  { group: 'action', emoji: '🆘', label: '求助', terms: ['求助', '帮忙', '求', '救命', '在线等'] },
  { group: 'action', emoji: '💔', label: '分手', terms: ['分手', '失恋', '前任', '感情破裂'] },
  { group: 'action', emoji: '🧧', label: '过年', terms: ['过年', '新年', '春节', '红包', '拜年'], featured: true },
